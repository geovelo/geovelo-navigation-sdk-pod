...
@class GNKClientOptions, GNKNavigationManager, GNKGeoSegment, GNKGeoPoint, GNKItinerarySegmentCompanion, GNKItinerarySegment, GNKItinerarySection, GNKItinerary, GNKNavigationEngineCompanion, GNKRecalculationBehavior, GNKNavigationProgress, GNKItineraryInstruction, GNKGeoSegmentQuadTree, GNKKotlinx_datetimeInstant, GNKWaypoint, GNKNavigationManagerCompanion, GNKNavigationProgressCompanion, GNKKotlinEnumCompanion, GNKKotlinEnum<E>, GNKRecalculationBehaviorCompanion, GNKKotlinArray<T>, GNKKotlinThrowable, GNKKotlinException, GNKItineraryType, GNKRoadTypeDistances, GNKItineraryCompanion, GNKItineraryBikeProfile, GNKItineraryBikeType, GNKBounds, GNKItineraryElevation, GNKTransportMode, GNKItineraryBikeMotorTypeCompanion, GNKItineraryBikeMotorType, GNKItineraryBikeProfileCompanion, GNKItineraryBikeTypeCompanion, GNKItinerarySectionEnergy, GNKItineraryEBikeEnergiesCompanion, GNKItineraryEBikeEnergies, GNKItineraryElevationCompanion, GNKItineraryInstructionRoadType, GNKItineraryFacilityCompanion, GNKItineraryFacility, GNKItineraryInstructionType, GNKItineraryInstructionCardinalDirection, GNKItineraryInstructionCompanion, GNKItineraryInstructionCardinalDirectionCompanion, GNKItineraryInstructionRoadTypeCompanion, GNKItineraryInstructionTypeCompanion, GNKItineraryLoopTypeCompanion, GNKItineraryLoopType, GNKItineraryPublicTransportStopPointCompanion, GNKItineraryPublicTransportStopPoint, GNKItineraryRequestCompanion, GNKItineraryRequestBikeDetails, GNKItineraryRequestNavigationDetails, GNKItineraryRequestLoopDetails, GNKItineraryRequest, GNKItineraryRequestBuilderCompanion, GNKItineraryRequestBuilder, GNKItineraryRequestBikeDetailsCompanion, GNKItineraryRequestLoopDetailsCompanion, GNKItineraryRequestNavigationDetailsCompanion, GNKItinerarySectionDetails, GNKItinerarySectionCompanion, GNKItinerarySectionBikeDetails, GNKItinerarySectionPedestrianDetails, GNKItinerarySectionPublicTransportDetails, GNKItinerarySectionBikeStations, GNKItinerarySectionBikeDetailsCompanion, GNKItinerarySectionBikeStationFromToCompanion, GNKItinerarySectionBikeStationFromTo, GNKItinerarySectionBikeStationsCompanion, GNKItinerarySectionRideSet, GNKItinerarySectionDetailsCompanion, GNKItinerarySectionEnergyCompanion, GNKItinerarySectionPedestrianDetailsCompanion, GNKItinerarySectionPublicTransportDetailsCompanion, GNKItinerarySectionRideSetCompanion, GNKItineraryTypeCompanion, GNKRoadTypeDistancesCompanion, GNKTransportModeCompanion, GNKPreconfiguredHttpClient, GNKKtor_client_coreHttpClient, GNKEncodedElevationsSerializer, GNKEncodedFacilitiesSerializer, GNKEncodedInstructionsSerializer, GNKEncodedInstructionsSerializerEncodedInstructionHeader, GNKEncodedLineStringSerializer, GNKItineraryBikeTypeSerializer, GNKGeometryEncoderCompanion, GNKRequestBuilderExceptionCompanion, GNKRequestBuilderExceptionType, GNKRequestBuilderException, GNKBoundsCompanion, GNKGeoLocationCompanion, GNKGeoLocation, GNKGeoPointCompanion, GNKGeoSegmentCompanion, GNKGeoSegmentQuadTreeCompanion, GNKWaypointCompanion, GNKInstantSerializer, GNKIntSerializer, GNKJsonDefaultsCompanion, GNKKotlinx_serialization_jsonJson, GNKInstantParceler, CLLocation, GNKResource, GNKKotlinRuntimeException, GNKKotlinx_datetimeInstantCompanion, GNKKtor_client_coreHttpClientEngineConfig, GNKKtor_client_coreHttpClientConfig<T>, GNKKtor_client_coreHttpRequestBuilder, GNKKtor_client_coreHttpClientCall, GNKKotlinx_coroutines_coreCoroutineDispatcher, GNKKtor_client_coreHttpReceivePipeline, GNKKtor_client_coreHttpRequestPipeline, GNKKtor_client_coreHttpResponsePipeline, GNKKtor_client_coreHttpSendPipeline, GNKKotlinx_serialization_coreSerializersModule, GNKKotlinx_serialization_coreSerialKind, GNKKotlinNothing, GNKKotlinx_serialization_jsonJsonConfiguration, GNKKotlinx_serialization_jsonJsonDefault, GNKKotlinx_serialization_jsonJsonElement, GNKKtor_client_coreHttpRequestData, GNKKtor_client_coreHttpResponseData, GNKKtor_client_coreProxyConfig, GNKKotlinIllegalStateException, GNKKtor_httpHeadersBuilder, GNKKtor_client_coreHttpRequestBuilderCompanion, GNKKtor_httpURLBuilder, GNKKtor_httpHttpMethod, GNKKtor_client_coreHttpClientCallCompanion, GNKKtor_client_coreTypeInfo, GNKKtor_client_coreHttpResponse, GNKKtor_utilsAttributeKey<T>, GNKKotlinAbstractCoroutineContextElement, GNKKotlinx_coroutines_coreCoroutineDispatcherKey, GNKKtor_utilsPipelinePhase, GNKKtor_utilsPipeline<TSubject, TContext>, GNKKtor_client_coreHttpReceivePipelinePhases, GNKKtor_client_coreHttpRequestPipelinePhases, GNKKtor_client_coreHttpResponsePipelinePhases, GNKKtor_client_coreHttpResponseContainer, GNKKtor_client_coreHttpSendPipelinePhases, GNKKotlinx_serialization_jsonJsonElementCompanion, GNKKtor_httpUrl, GNKKtor_httpOutgoingContent, GNKKtor_httpHttpStatusCode, GNKKtor_utilsGMTDate, GNKKtor_httpHttpProtocolVersion, GNKKtor_utilsStringValuesBuilder, GNKKtor_httpURLProtocol, GNKKtor_httpParametersBuilder, GNKKtor_httpURLBuilderCompanion, GNKKotlinCancellationException, GNKKotlinUnit, GNKKtor_httpHttpMethodCompanion, GNKKtor_ioMemory, GNKKtor_ioIoBuffer, GNKKotlinByteArray, GNKKtor_ioByteReadPacket, GNKKtor_ioByteOrder, GNKKotlinAbstractCoroutineContextKey<B, E>, GNKKtor_httpUrlCompanion, GNKKtor_httpContentType, GNKKtor_httpHttpStatusCodeCompanion, GNKKtor_utilsGMTDateCompanion, GNKKtor_utilsWeekDay, GNKKtor_utilsMonth, GNKKtor_httpHttpProtocolVersionCompanion, GNKKtor_httpURLProtocolCompanion, GNKKtor_httpUrlEncodingOption, GNKKtor_ioMemoryCompanion, GNKKtor_ioBufferCompanion, GNKKtor_ioBuffer, GNKKtor_ioChunkBuffer, GNKKtor_ioChunkBufferCompanion, GNKKotlinCharArray, GNKKtor_ioIoBufferCompanion, GNKKotlinByteIterator, GNKKtor_ioAbstractInputCompanion, GNKKtor_ioAbstractInput, GNKKtor_ioByteReadPacketBaseCompanion, GNKKtor_ioByteReadPacketBase, GNKKtor_ioByteReadPacketPlatformBase, GNKKtor_ioByteReadPacketCompanion, GNKKtor_ioByteOrderCompanion, GNKKotlinKTypeProjection, GNKKtor_httpHeaderValueParam, GNKKtor_httpHeaderValueWithParametersCompanion, GNKKtor_httpHeaderValueWithParameters, GNKKtor_httpContentTypeCompanion, GNKKtor_utilsWeekDayCompanion, GNKKtor_utilsMonthCompanion, GNKKotlinx_coroutines_coreAtomicDesc, GNKKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, GNKKotlinCharIterator, GNKKotlinKVariance, GNKKotlinKTypeProjectionCompanion, GNKKotlinx_coroutines_coreAtomicOp<__contravariant T>, GNKKotlinx_coroutines_coreOpDescriptor, GNKKotlinx_coroutines_coreLockFreeLinkedListNode, GNKKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, GNKKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, GNKKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>;

@protocol GNKExceptionHandler, GNKLogHandler, GNKItineraryClient, GNKCommonParcelable, GNKGeoSegmentable, GNKKotlinx_serialization_coreKSerializer, GNKNavigationLifecycleListener, GNKNavigationProgressListener, GNKNavigationRecalculateListener, GNKKotlinComparable, GNKItineraryListCallback, GNKItineraryCallback, GNKKotlinCoroutineContext, GNKKotlinx_serialization_coreEncoder, GNKKotlinx_serialization_coreSerialDescriptor, GNKKotlinx_serialization_coreSerializationStrategy, GNKKotlinx_serialization_coreDecoder, GNKKotlinx_serialization_coreDeserializationStrategy, GNKCommonParceler, GNKKotlinIterator, GNKKotlinx_coroutines_coreCoroutineScope, GNKKtor_ioCloseable, GNKKtor_client_coreHttpClientEngine, GNKKtor_client_coreHttpClientEngineCapability, GNKKtor_utilsAttributes, GNKKotlinCoroutineContextElement, GNKKotlinCoroutineContextKey, GNKKotlinx_serialization_coreCompositeEncoder, GNKKotlinAnnotation, GNKKotlinx_serialization_coreCompositeDecoder, GNKKotlinx_serialization_coreSerialFormat, GNKKotlinx_serialization_coreStringFormat, GNKKtor_client_coreHttpClientFeature, GNKKtor_httpHttpMessageBuilder, GNKKotlinx_coroutines_coreJob, GNKKtor_ioByteReadChannel, GNKKtor_utilsTypeInfo, GNKKtor_client_coreHttpRequest, GNKKotlinContinuation, GNKKotlinContinuationInterceptor, GNKKotlinx_coroutines_coreRunnable, GNKKotlinSuspendFunction2, GNKKotlinx_serialization_coreSerializersModuleCollector, GNKKotlinKClass, GNKKtor_httpHeaders, GNKKtor_utilsStringValues, GNKKotlinMapEntry, GNKKotlinx_coroutines_coreChildHandle, GNKKotlinx_coroutines_coreChildJob, GNKKotlinx_coroutines_coreDisposableHandle, GNKKotlinSequence, GNKKotlinx_coroutines_coreSelectClause0, GNKKtor_ioReadSession, GNKKotlinSuspendFunction1, GNKKotlinAppendable, GNKKotlinKType, GNKKtor_httpHttpMessage, GNKKotlinFunction, GNKKotlinKDeclarationContainer, GNKKotlinKAnnotatedElement, GNKKotlinKClassifier, GNKKtor_httpParameters, GNKKotlinx_coroutines_coreParentJob, GNKKotlinx_coroutines_coreSelectInstance, GNKKotlinSuspendFunction0, GNKKtor_ioObjectPool, GNKKtor_ioInput, GNKKtor_ioOutput;
...
- (instancetype)initWithApiKey:(NSString *)apiKey exceptionListener:(id<GNKExceptionHandler>)exceptionListener logHandler:(id<GNKLogHandler>)logHandler clientOptions:(GNKClientOptions *)clientOptions __attribute__((swift_name("init(apiKey:exceptionListener:logHandler:clientOptions:)"))) __attribute__((objc_designated_initializer));
 ...
 */
- (GNKGeoPoint *)component3 __attribute__((swift_name("component3()")));
 ...
 */
- (GNKGeoPoint *)component5 __attribute__((swift_name("component5()")));
...
- (GNKKotlinx_datetimeInstant *)component1 __attribute__((swift_name("component1()")));
...
- (GNKGeoPoint *)component14 __attribute__((swift_name("component14()")));
- (GNKGeoPoint *)component15 __attribute__((swift_name("component15()")));
- (GNKKotlinx_datetimeInstant *)component16 __attribute__((swift_name("component16()")));
- (double)component17 __attribute__((swift_name("component17()")));
- (GNKItinerarySection * _Nullable)component18 __attribute__((swift_name("component18()")));
- (GNKItinerary * _Nullable)component19 __attribute__((swift_name("component19()")));
- (GNKItineraryInstruction *)component2 __attribute__((swift_name("component2()")));
- (GNKItinerarySection *)component20 __attribute__((swift_name("component20()")));
- (GNKItineraryInstruction * _Nullable)component3 __attribute__((swift_name("component3()")));
- (GNKItineraryInstruction * _Nullable)component4 __attribute__((swift_name("component4()")));
- (GNKItinerarySegment *)component5 __attribute__((swift_name("component5()")));
- (GNKItinerary *)component6 __attribute__((swift_name("component6()")));
 ...
 */
- (GNKKotlinx_datetimeInstant * _Nullable)component2 __attribute__((swift_name("component2()")));

/**
 * Estimated date of departure
 */
- (GNKKotlinx_datetimeInstant * _Nullable)component3 __attribute__((swift_name("component3()")));
 ...
 */
- (GNKItineraryType *)component5 __attribute__((swift_name("component5()")));

/**
 * Distances by kind (recommended, discouraged, normal, total)
 */
- (GNKRoadTypeDistances *)component6 __attribute__((swift_name("component6()")));

/**
 * Start, steps and end points
 */
- (NSMutableArray<GNKWaypoint *> *)component7 __attribute__((swift_name("component7()")));

/**
 * Parts of the itinerary, each part is based on TransportMode
 */
- (NSMutableArray<GNKItinerarySection *> *)component8 __attribute__((swift_name("component8()")));
 ...
 */
- (GNKItinerarySectionEnergy * _Nullable)component1 __attribute__((swift_name("component1()")));

/**
 * Energies remaining at the end of the itinerary using maximum assistance level
 */
- (GNKItinerarySectionEnergy * _Nullable)component2 __attribute__((swift_name("component2()")));
 ...
 * Altitude on earth
 */
- (GNKItineraryInstructionRoadType *)component2 __attribute__((swift_name("component2()")));
 ...
 */
- (GNKItineraryInstructionType *)component2 __attribute__((swift_name("component2()")));
 ...
 * Facility kind
 */
- (GNKItineraryInstructionRoadType *)component6 __attribute__((swift_name("component6()")));

/**
 * Name of the road to which the instruction leads
 */
- (NSMutableArray<NSString *> *)component7 __attribute__((swift_name("component7()")));

/**
 * North, West, etc.
 */
- (GNKItineraryInstructionCardinalDirection *)component8 __attribute__((swift_name("component8()")));
...
- (GNKKotlinx_datetimeInstant * _Nullable)component4 __attribute__((swift_name("component4()")));
- (GNKKotlinx_datetimeInstant * _Nullable)component5 __attribute__((swift_name("component5()")));
...
- (NSArray<GNKGeoPoint *> * _Nullable)component10 __attribute__((swift_name("component10()")));
- (NSArray<GNKTransportMode *> *)component11 __attribute__((swift_name("component11()")));
- (GNKItineraryRequestBikeDetails * _Nullable)component12 __attribute__((swift_name("component12()")));
- (GNKItineraryRequestNavigationDetails * _Nullable)component13 __attribute__((swift_name("component13()")));
- (GNKItineraryRequestLoopDetails * _Nullable)component14 __attribute__((swift_name("component14()")));
...
- (GNKKotlinx_datetimeInstant * _Nullable)component7 __attribute__((swift_name("component7()")));
- (GNKKotlinx_datetimeInstant * _Nullable)component8 __attribute__((swift_name("component8()")));
- (NSArray<GNKWaypoint *> *)component9 __attribute__((swift_name("component9()")));
...
- (GNKItineraryLoopType *)component1 __attribute__((swift_name("component1()")));
- (int32_t)component2 __attribute__((swift_name("component2()")));
- (int32_t)component3 __attribute__((swift_name("component3()")));
- (int32_t)component4 __attribute__((swift_name("component4()")));
...
- (GNKKotlinx_datetimeInstant * _Nullable)component1 __attribute__((swift_name("component1()")));
 ...
 */
- (GNKBounds * _Nullable)component13 __attribute__((swift_name("component13()")));
- (GNKKotlinx_datetimeInstant * _Nullable)component2 __attribute__((swift_name("component2()")));
 ...
 */
- (NSMutableArray<GNKGeoPoint *> *)component4 __attribute__((swift_name("component4()")));

/**
 * Transport mode used in this section
 */
- (GNKTransportMode *)component5 __attribute__((swift_name("component5()")));

/**
 * Ordered waypoints (contains start / end / any step given by user or step calculated)
 */
- (NSMutableArray<GNKWaypoint *> *)component6 __attribute__((swift_name("component6()")));

/**
 * Energy used for the trip
 */
- (GNKItineraryEBikeEnergies * _Nullable)component7 __attribute__((swift_name("component7()")));

/**
 * List of index of waypoints in the geometry.
 */
- (NSMutableArray<GNKInt *> *)component8 __attribute__((swift_name("component8()")));
- (GNKItinerarySectionDetails * _Nullable)component9 __attribute__((swift_name("component9()")));
...
- (int32_t)component10 __attribute__((swift_name("component10()")));
- (NSMutableArray<GNKItineraryElevation *> *)component11 __attribute__((swift_name("component11()")));
- (NSMutableArray<GNKItineraryInstruction *> *)component12 __attribute__((swift_name("component12()")));
- (NSMutableArray<GNKItineraryFacility *> *)component13 __attribute__((swift_name("component13()")));

/**
 * Number of meters of main kinds of roads
 */
- (GNKRoadTypeDistances *)component2 __attribute__((swift_name("component2()")));
- (GNKItineraryBikeType *)component3 __attribute__((swift_name("component3()")));
- (GNKItineraryBikeProfile *)component4 __attribute__((swift_name("component4()")));
- (GNKItinerarySectionBikeStations * _Nullable)component5 __attribute__((swift_name("component5()")));
- (int32_t)component6 __attribute__((swift_name("component6()")));
 ...
 */
- (GNKItinerarySectionBikeStationFromTo * _Nullable)component1 __attribute__((swift_name("component1()")));

/**
 * The BikeStations near the itinerary arrival
 */
- (GNKItinerarySectionBikeStationFromTo * _Nullable)component2 __attribute__((swift_name("component2()")));
...
- (NSMutableArray<GNKItinerarySectionRideSet *> *)component14 __attribute__((swift_name("component14()")));
...
- (NSMutableArray<GNKItineraryPublicTransportStopPoint *> *)component21 __attribute__((swift_name("component21()")));
- (NSMutableArray<GNKItineraryElevation *> *)component3 __attribute__((swift_name("component3()")));
- (NSMutableArray<GNKItineraryInstruction *> *)component4 __attribute__((swift_name("component4()")));
- (NSMutableArray<GNKItineraryFacility *> *)component5 __attribute__((swift_name("component5()")));
- (GNKItineraryBikeType *)component6 __attribute__((swift_name("component6()")));
- (GNKItineraryBikeProfile *)component7 __attribute__((swift_name("component7()")));
- (GNKItinerarySectionBikeStations * _Nullable)component8 __attribute__((swift_name("component8()")));
- (int32_t)component9 __attribute__((swift_name("component9()")));
...
- (int32_t)component3 __attribute__((swift_name("component3()")));
- (int32_t)component4 __attribute__((swift_name("component4()")));
- (GNKRoadTypeDistances *)component5 __attribute__((swift_name("component5()")));
- (int32_t)component6 __attribute__((swift_name("component6()")));
- (NSMutableArray<GNKItineraryElevation *> *)component7 __attribute__((swift_name("component7()")));
- (NSMutableArray<GNKItineraryInstruction *> *)component8 __attribute__((swift_name("component8()")));
...
- (GNKRoadTypeDistances *)component7 __attribute__((swift_name("component7()")));
- (NSMutableArray<GNKItineraryPublicTransportStopPoint *> *)component8 __attribute__((swift_name("component8()")));
- (NSMutableArray<GNKItineraryInstruction *> *)component9 __attribute__((swift_name("component9()")));
 ...
 */
- (NSMutableArray<GNKInt *> *)component2 __attribute__((swift_name("component2()")));
...
- (GNKGeoPoint *)component1 __attribute__((swift_name("component1()")));
...
- (GNKGeoPoint *)component1 __attribute__((swift_name("component1()")));
- (GNKGeoPoint *)component2 __attribute__((swift_name("component2()")));
...
- (void)updateLocationLocation:(CLLocation *)location __attribute__((swift_name("updateLocation(location:)")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)executeBuilder:(GNKKtor_client_coreHttpRequestBuilder *)builder completionHandler:(void (^)(GNKKtor_client_coreHttpClientCall * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("execute(builder:completionHandler:)"))) __attribute__((unavailable("Unbound [HttpClientCall] is deprecated. Consider using [request<HttpResponse>(builder)] instead.")));
...
@property (readonly) id<GNKKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@property (readonly) GNKKotlinx_coroutines_coreCoroutineDispatcher *dispatcher __attribute__((swift_name("dispatcher"))) __attribute__((unavailable("[dispatcher] is deprecated. Use coroutineContext instead.")));
...
- (id<GNKKotlinx_serialization_coreEncoder>)encodeInlineInlineDescriptor:(id<GNKKotlinx_serialization_coreSerialDescriptor>)inlineDescriptor __attribute__((swift_name("encodeInline(inlineDescriptor:)")));
...
- (id<GNKKotlinx_serialization_coreDecoder>)decodeInlineInlineDescriptor:(id<GNKKotlinx_serialization_coreSerialDescriptor>)inlineDescriptor __attribute__((swift_name("decodeInline(inlineDescriptor:)")));
...
- (instancetype)initWithConfiguration:(GNKKotlinx_serialization_jsonJsonConfiguration *)configuration serializersModule:(GNKKotlinx_serialization_coreSerializersModule *)serializersModule __attribute__((swift_name("init(configuration:serializersModule:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) GNKKotlinNothing *response __attribute__((swift_name("response"))) __attribute__((unavailable("Response config is deprecated. See [HttpPlainText] feature for charset configuration")));
...
- (void)installClient:(GNKKtor_client_coreHttpClient *)client __attribute__((swift_name("install(client:)")));
- (void)installFeature:(id<GNKKtor_client_coreHttpClientFeature>)feature configure:(void (^)(id))configure __attribute__((swift_name("install(feature:configure:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)receiveInfo:(GNKKtor_client_coreTypeInfo *)info completionHandler:(void (^)(id _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("receive(info:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)receiveInfo:(id<GNKKtor_utilsTypeInfo>)info completionHandler_:(void (^)(id _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("receive(info:completionHandler_:)")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) BOOL allowDoubleReceive __attribute__((swift_name("allowDoubleReceive")));
@property (readonly) id<GNKKtor_utilsAttributes> attributes __attribute__((swift_name("attributes")));
@property (readonly) GNKKtor_client_coreHttpClient * _Nullable client __attribute__((swift_name("client")));
@property (readonly) id<GNKKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@property (readonly) id<GNKKtor_client_coreHttpRequest> request __attribute__((swift_name("request")));
@property (readonly) GNKKtor_client_coreHttpResponse *response __attribute__((swift_name("response")));
@end;
...
@interface GNKKtor_client_coreHttpReceivePipeline : GNKKtor_utilsPipeline<GNKKtor_client_coreHttpResponse *, GNKKtor_client_coreHttpClientCall *>
...
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithConfiguration:(GNKKotlinx_serialization_jsonJsonConfiguration *)configuration serializersModule:(GNKKotlinx_serialization_coreSerializersModule *)serializersModule __attribute__((swift_name("init(configuration:serializersModule:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
@protocol GNKKtor_client_coreHttpClientFeature
@required
- (void)installFeature:(id)feature scope:(GNKKtor_client_coreHttpClient *)scope __attribute__((swift_name("install(feature:scope:)")));
- (id)prepareBlock:(void (^)(id))block __attribute__((swift_name("prepare(block:)")));
@property (readonly) GNKKtor_utilsAttributeKey<id> *key __attribute__((swift_name("key")));
@end;

__attribute__((swift_name("Ktor_utilsStringValuesBuilder")))
@interface GNKKtor_utilsStringValuesBuilder : GNKBase
...
@interface GNKKtor_httpHeadersBuilder : GNKKtor_utilsStringValuesBuilder
...
- (instancetype)initWithProtocol:(GNKKtor_httpURLProtocol *)protocol host:(NSString *)host port:(int32_t)port user:(NSString * _Nullable)user password:(NSString * _Nullable)password encodedPath:(NSString *)encodedPath parameters:(GNKKtor_httpParametersBuilder *)parameters fragment:(NSString *)fragment trailingQuery:(BOOL)trailingQuery __attribute__((swift_name("init(protocol:host:port:user:password:encodedPath:parameters:fragment:trailingQuery:)"))) __attribute__((objc_designated_initializer));
...
- (GNKKtor_httpURLBuilder *)pathComponents:(GNKKotlinArray<NSString *> *)components __attribute__((swift_name("path(components:)")));
- (GNKKtor_httpURLBuilder *)pathComponents_:(NSArray<NSString *> *)components __attribute__((swift_name("path(components_:)")));
@property NSString *encodedPath __attribute__((swift_name("encodedPath")));
@property NSString *fragment __attribute__((swift_name("fragment")));
@property NSString *host __attribute__((swift_name("host")));
@property (readonly) GNKKtor_httpParametersBuilder *parameters __attribute__((swift_name("parameters")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)joinWithCompletionHandler:(void (^)(GNKKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("join(completionHandler:)")));
...
@property (readonly) GNKKtor_utilsAttributeKey<id> *CustomResponse __attribute__((swift_name("CustomResponse"))) __attribute__((deprecated("This is going to be removed. Please file a ticket with clarification why and what for do you need it.")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readAvailableDst:(GNKKtor_ioIoBuffer *)dst completionHandler:(void (^)(GNKInt * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readAvailable(dst:completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readFullyDst:(GNKKtor_ioIoBuffer *)dst n:(int32_t)n completionHandler:(void (^)(GNKKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readFully(dst:n:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readFullyDst:(GNKKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length completionHandler:(void (^)(GNKKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readFully(dst:offset:length:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readFullyDst:(void *)dst offset:(int32_t)offset length:(int32_t)length completionHandler_:(void (^)(GNKKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readFully(dst:offset:length:completionHandler_:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readFullyDst:(void *)dst offset:(int64_t)offset length:(int64_t)length completionHandler__:(void (^)(GNKKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readFully(dst:offset:length:completionHandler__:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readPacketSize:(int32_t)size headerSizeHint:(int32_t)headerSizeHint completionHandler:(void (^)(GNKKtor_ioByteReadPacket * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readPacket(size:headerSizeHint:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readRemainingLimit:(int64_t)limit headerSizeHint:(int32_t)headerSizeHint completionHandler:(void (^)(GNKKtor_ioByteReadPacket * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readRemaining(limit:headerSizeHint:completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readSuspendableSessionConsumer:(id<GNKKotlinSuspendFunction1>)consumer completionHandler:(void (^)(GNKKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readSuspendableSession(consumer:completionHandler:)"))) __attribute__((deprecated("Use read { } instead.")));
...
@property GNKKtor_ioByteOrder *readByteOrder __attribute__((swift_name("readByteOrder"))) __attribute__((unavailable("Setting byte order is no longer supported. Read/write in big endian and use reverseByteOrder() extensions.")));
@property (readonly) int64_t totalBytesRead __attribute__((swift_name("totalBytesRead")));
@end;

__attribute__((swift_name("Ktor_utilsTypeInfo")))
@protocol GNKKtor_utilsTypeInfo
@required
...
@interface GNKKtor_client_coreTypeInfo : GNKBase <GNKKtor_utilsTypeInfo>
- (instancetype)initWithType:(id<GNKKotlinKClass>)type reifiedType:(id<GNKKotlinKType>)reifiedType kotlinType:(id<GNKKotlinKType> _Nullable)kotlinType __attribute__((swift_name("init(type:reifiedType:kotlinType:)"))) __attribute__((objc_designated_initializer)) __attribute__((deprecated("This was moved to another package.")));
- (id<GNKKotlinKClass>)component1 __attribute__((swift_name("component1()")));
- (id<GNKKotlinKType>)component2 __attribute__((swift_name("component2()")));
- (id<GNKKotlinKType> _Nullable)component3 __attribute__((swift_name("component3()")));
- (GNKKtor_client_coreTypeInfo *)doCopyType:(id<GNKKotlinKClass>)type reifiedType:(id<GNKKotlinKType>)reifiedType kotlinType:(id<GNKKotlinKType> _Nullable)kotlinType __attribute__((swift_name("doCopy(type:reifiedType:kotlinType:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) id<GNKKotlinKType> _Nullable kotlinType __attribute__((swift_name("kotlinType")));
...
- (instancetype)initWithExpectedType:(id<GNKKtor_utilsTypeInfo>)expectedType response:(id)response __attribute__((swift_name("init(expectedType:response:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithExpectedType:(GNKKtor_client_coreTypeInfo *)expectedType response_:(id)response __attribute__((swift_name("init(expectedType:response_:)"))) __attribute__((objc_designated_initializer));
- (GNKKtor_client_coreTypeInfo *)component1 __attribute__((swift_name("component1()")));
- (id)component2 __attribute__((swift_name("component2()")));
- (GNKKtor_client_coreHttpResponseContainer *)doCopyExpectedType:(GNKKtor_client_coreTypeInfo *)expectedType response:(id)response __attribute__((swift_name("doCopy(expectedType:response:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) GNKKtor_client_coreTypeInfo *expectedType __attribute__((swift_name("expectedType")));
...
- (void)polymorphicDefaultBaseClass:(id<GNKKotlinKClass>)baseClass defaultSerializerProvider:(id<GNKKotlinx_serialization_coreDeserializationStrategy> _Nullable (^)(NSString * _Nullable))defaultSerializerProvider __attribute__((swift_name("polymorphicDefault(baseClass:defaultSerializerProvider:)")));
@end;
...
- (instancetype)initWithProtocol:(GNKKtor_httpURLProtocol *)protocol host:(NSString *)host specifiedPort:(int32_t)specifiedPort encodedPath:(NSString *)encodedPath parameters:(id<GNKKtor_httpParameters>)parameters fragment:(NSString *)fragment user:(NSString * _Nullable)user password:(NSString * _Nullable)password trailingQuery:(BOOL)trailingQuery __attribute__((swift_name("init(protocol:host:specifiedPort:encodedPath:parameters:fragment:user:password:trailingQuery:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) GNKKtor_httpUrlCompanion *companion __attribute__((swift_name("companion")));
- (GNKKtor_httpURLProtocol *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (int32_t)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (id<GNKKtor_httpParameters>)component5 __attribute__((swift_name("component5()")));
- (NSString *)component6 __attribute__((swift_name("component6()")));
- (NSString * _Nullable)component7 __attribute__((swift_name("component7()")));
- (NSString * _Nullable)component8 __attribute__((swift_name("component8()")));
- (BOOL)component9 __attribute__((swift_name("component9()")));
- (GNKKtor_httpUrl *)doCopyProtocol:(GNKKtor_httpURLProtocol *)protocol host:(NSString *)host specifiedPort:(int32_t)specifiedPort encodedPath:(NSString *)encodedPath parameters:(id<GNKKtor_httpParameters>)parameters fragment:(NSString *)fragment user:(NSString * _Nullable)user password:(NSString * _Nullable)password trailingQuery:(BOOL)trailingQuery __attribute__((swift_name("doCopy(protocol:host:specifiedPort:encodedPath:parameters:fragment:user:password:trailingQuery:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (int32_t)component2 __attribute__((swift_name("component2()")));
- (int32_t)component3 __attribute__((swift_name("component3()")));
- (GNKKtor_utilsWeekDay *)component4 __attribute__((swift_name("component4()")));
- (int32_t)component5 __attribute__((swift_name("component5()")));
- (int32_t)component6 __attribute__((swift_name("component6()")));
- (GNKKtor_utilsMonth *)component7 __attribute__((swift_name("component7()")));
- (int32_t)component8 __attribute__((swift_name("component8()")));
...
@interface GNKKtor_httpParametersBuilder : GNKKtor_utilsStringValuesBuilder
- (instancetype)initWithSize:(int32_t)size urlEncodingOption:(GNKKtor_httpUrlEncodingOption *)urlEncodingOption __attribute__((swift_name("init(size:urlEncodingOption:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithCaseInsensitiveName:(BOOL)caseInsensitiveName size:(int32_t)size __attribute__((swift_name("init(caseInsensitiveName:size:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (id<GNKKtor_httpParameters>)build __attribute__((swift_name("build()")));
@property GNKKtor_httpUrlEncodingOption *urlEncodingOption __attribute__((swift_name("urlEncodingOption")));
@end;
...
@protocol GNKKtor_ioInput <GNKKtor_ioCloseable>
@required
...
@property GNKKtor_ioByteOrder *byteOrder __attribute__((swift_name("byteOrder"))) __attribute__((unavailable("Not supported anymore. All operations are big endian by default. Use readXXXLittleEndian or readXXX then X.reverseByteOrder() instead.")));
...
@protocol GNKKtor_ioOutput <GNKKotlinAppendable, GNKKtor_ioCloseable>
@required
- (id<GNKKotlinAppendable>)appendCsq:(GNKKotlinCharArray *)csq start:(int32_t)start end:(int32_t)end __attribute__((swift_name("append(csq:start:end:)")));
- (void)flush __attribute__((swift_name("flush()")));
- (void)writeByteV:(int8_t)v __attribute__((swift_name("writeByte(v:)")));
@property GNKKtor_ioByteOrder *byteOrder __attribute__((swift_name("byteOrder"))) __attribute__((deprecated("Write with writeXXXLittleEndian or do X.reverseByteOrder() and then writeXXX instead.")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Ktor_ioIoBuffer")))
@interface GNKKtor_ioIoBuffer : GNKKtor_ioChunkBuffer <GNKKtor_ioInput, GNKKtor_ioOutput>
- (instancetype)initWithMemory:(GNKKtor_ioMemory *)memory origin:(GNKKtor_ioChunkBuffer * _Nullable)origin __attribute__((swift_name("init(memory:origin:)"))) __attribute__((objc_designated_initializer)) __attribute__((deprecated("Use Buffer instead.")));
...
- (instancetype)initWithMemory:(GNKKtor_ioMemory *)memory origin:(GNKKtor_ioChunkBuffer * _Nullable)origin parentPool:(id<GNKKtor_ioObjectPool> _Nullable)parentPool __attribute__((swift_name("init(memory:origin:parentPool:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) GNKKtor_ioIoBufferCompanion *companion __attribute__((swift_name("companion")));
- (id<GNKKotlinAppendable>)appendValue:(unichar)c __attribute__((swift_name("append(value:)")));
- (id<GNKKotlinAppendable>)appendCsq:(GNKKotlinCharArray *)csq start:(int32_t)start end:(int32_t)end __attribute__((swift_name("append(csq:start:end:)")));
- (id<GNKKotlinAppendable>)appendValue_:(id _Nullable)csq __attribute__((swift_name("append(value_:)")));
- (id<GNKKotlinAppendable>)appendValue:(id _Nullable)csq startIndex:(int32_t)start endIndex:(int32_t)end __attribute__((swift_name("append(value:startIndex:endIndex:)")));
- (int32_t)appendCharsCsq:(GNKKotlinCharArray *)csq start:(int32_t)start end:(int32_t)end __attribute__((swift_name("appendChars(csq:start:end:)")));
- (int32_t)appendCharsCsq:(id)csq start:(int32_t)start end_:(int32_t)end __attribute__((swift_name("appendChars(csq:start:end_:)")));
- (void)close __attribute__((swift_name("close()")));
- (GNKKtor_ioIoBuffer *)duplicate __attribute__((swift_name("duplicate()")));
- (void)flush __attribute__((swift_name("flush()")));
- (GNKKtor_ioIoBuffer *)makeView __attribute__((swift_name("makeView()")));
- (int64_t)peekToDestination:(GNKKtor_ioMemory *)destination destinationOffset:(int64_t)destinationOffset offset:(int64_t)offset min:(int64_t)min max:(int64_t)max __attribute__((swift_name("peekTo(destination:destinationOffset:offset:min:max:)")));
- (int32_t)readDirectBlock:(GNKInt *(^)(id))block __attribute__((swift_name("readDirect(block:)")));
- (void)releasePool_:(id<GNKKtor_ioObjectPool>)pool __attribute__((swift_name("release(pool_:)")));
- (NSString *)description __attribute__((swift_name("description()")));
- (int32_t)tryPeek __attribute__((swift_name("tryPeek()")));
- (int32_t)writeDirectBlock:(GNKInt *(^)(id))block __attribute__((swift_name("writeDirect(block:)")));
@property GNKKtor_ioByteOrder *byteOrder __attribute__((swift_name("byteOrder"))) __attribute__((unavailable("Not supported anymore. All operations are big endian by default.")));
@property (readonly) BOOL endOfInput __attribute__((swift_name("endOfInput")));
@end;
...
@interface GNKKtor_ioAbstractInput : GNKBase <GNKKtor_ioInput>
- (instancetype)initWithHead:(GNKKtor_ioChunkBuffer *)head remaining:(int64_t)remaining pool:(id<GNKKtor_ioObjectPool>)pool __attribute__((swift_name("init(head:remaining:pool:)"))) __attribute__((objc_designated_initializer)) __attribute__((deprecated("AbstractInput is deprecated and will be merged with Input in 2.0.0")));
@property (class, readonly, getter=companion) GNKKtor_ioAbstractInputCompanion *companion __attribute__((swift_name("companion")));
...
- (GNKKtor_ioChunkBuffer * _Nullable)ensureNextHeadCurrent:(GNKKtor_ioChunkBuffer *)current __attribute__((swift_name("ensureNextHead(current:)")));
...
- (void)fixGapAfterReadCurrent:(GNKKtor_ioChunkBuffer *)current __attribute__((swift_name("fixGapAfterRead(current:)")));
- (BOOL)hasBytesN:(int32_t)n __attribute__((swift_name("hasBytes(n:)")));
- (void)markNoMoreChunksAvailable __attribute__((swift_name("markNoMoreChunksAvailable()")));
- (int64_t)peekToDestination:(GNKKtor_ioMemory *)destination destinationOffset:(int64_t)destinationOffset offset:(int64_t)offset min:(int64_t)min max:(int64_t)max __attribute__((swift_name("peekTo(destination:destinationOffset:offset:min:max:)")));
- (GNKKtor_ioChunkBuffer * _Nullable)prepareReadHeadMinSize:(int32_t)minSize __attribute__((swift_name("prepareReadHead(minSize:)")));
- (int8_t)readByte __attribute__((swift_name("readByte()")));
...
@interface GNKKtor_ioByteReadPacketBase : GNKKtor_ioAbstractInput
- (instancetype)initWithHead:(GNKKtor_ioChunkBuffer *)head remaining:(int64_t)remaining pool:(id<GNKKtor_ioObjectPool>)pool __attribute__((swift_name("init(head:remaining:pool:)"))) __attribute__((objc_designated_initializer)) __attribute__((deprecated("Will be removed in the future releases. Use Input or AbstractInput instead.")));
@property (class, readonly, getter=companion) GNKKtor_ioByteReadPacketBaseCompanion *companion __attribute__((swift_name("companion")));
@end;

__attribute__((swift_name("Ktor_ioByteReadPacketPlatformBase")))
@interface GNKKtor_ioByteReadPacketPlatformBase : GNKKtor_ioByteReadPacketBase
- (instancetype)initWithHead:(GNKKtor_ioChunkBuffer *)head remaining:(int64_t)remaining pool:(id<GNKKtor_ioObjectPool>)pool __attribute__((swift_name("init(head:remaining:pool:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable("Will be removed in future releases.")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Ktor_ioByteReadPacket")))
@interface GNKKtor_ioByteReadPacket : GNKKtor_ioByteReadPacketPlatformBase <GNKKtor_ioInput>
...
@required
- (int32_t)discardN_:(int32_t)n __attribute__((swift_name("discard(n_:)")));
- (GNKKtor_ioIoBuffer * _Nullable)requestAtLeast:(int32_t)atLeast __attribute__((swift_name("request(atLeast:)")));
@property (readonly) int32_t availableForRead __attribute__((swift_name("availableForRead")));
@end;
...
@interface GNKKtor_ioByteOrder : GNKKotlinEnum<GNKKtor_ioByteOrder *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) GNKKtor_ioByteOrderCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) GNKKtor_ioByteOrder *bigEndian __attribute__((swift_name("bigEndian")));
@property (class, readonly) GNKKtor_ioByteOrder *littleEndian __attribute__((swift_name("littleEndian")));
+ (GNKKotlinArray<GNKKtor_ioByteOrder *> *)values __attribute__((swift_name("values()")));
@end;
...
@required
@property (readonly) GNKKtor_httpUrlEncodingOption *urlEncodingOption __attribute__((swift_name("urlEncodingOption")));
@end;
...
@interface GNKKtor_httpUrlEncodingOption : GNKKotlinEnum<GNKKtor_httpUrlEncodingOption *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) GNKKtor_httpUrlEncodingOption *default_ __attribute__((swift_name("default_")));
@property (class, readonly) GNKKtor_httpUrlEncodingOption *keyOnly __attribute__((swift_name("keyOnly")));
@property (class, readonly) GNKKtor_httpUrlEncodingOption *valueOnly __attribute__((swift_name("valueOnly")));
@property (class, readonly) GNKKtor_httpUrlEncodingOption *noEncoding __attribute__((swift_name("noEncoding")));
+ (GNKKotlinArray<GNKKtor_httpUrlEncodingOption *> *)values __attribute__((swift_name("values()")));
@end;
...
@interface GNKKotlinCharArray : GNKBase
+ (instancetype)arrayWithSize:(int32_t)size __attribute__((swift_name("init(size:)")));
+ (instancetype)arrayWithSize:(int32_t)size init:(id (^)(GNKInt *))init __attribute__((swift_name("init(size:init:)")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (unichar)getIndex:(int32_t)index __attribute__((swift_name("get(index:)")));
- (GNKKotlinCharIterator *)iterator __attribute__((swift_name("iterator()")));
...
@interface GNKKtor_ioIoBufferCompanion : GNKBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) GNKKtor_ioIoBufferCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) GNKKtor_ioIoBuffer *Empty __attribute__((swift_name("Empty")));
@property (readonly) id<GNKKtor_ioObjectPool> EmptyPool __attribute__((swift_name("EmptyPool")));
@property (readonly) id<GNKKtor_ioObjectPool> NoPool __attribute__((swift_name("NoPool")));
@property (readonly) id<GNKKtor_ioObjectPool> Pool __attribute__((swift_name("Pool")));
@property (readonly) int32_t ReservedSize __attribute__((swift_name("ReservedSize")));
@end;
...
@interface GNKKtor_ioAbstractInputCompanion : GNKBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) GNKKtor_ioAbstractInputCompanion *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Ktor_ioByteReadPacketBase.Companion")))
@interface GNKKtor_ioByteReadPacketBaseCompanion : GNKBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) GNKKtor_ioByteReadPacketBaseCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) GNKKtor_ioByteReadPacket *Empty __attribute__((swift_name("Empty"))) __attribute__((unavailable("Use ByteReadPacket.Empty instead")));
@end;
...
@interface GNKKtor_ioByteOrderCompanion : GNKBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) GNKKtor_ioByteOrderCompanion *shared __attribute__((swift_name("shared")));
- (GNKKtor_ioByteOrder *)nativeOrder __attribute__((swift_name("nativeOrder()")));
@end;
...
- (GNKKotlinKVariance * _Nullable)component1 __attribute__((swift_name("component1()")));
- (id<GNKKotlinKType> _Nullable)component2 __attribute__((swift_name("component2()")));
...
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (GNKKtor_httpHeaderValueParam *)doCopyName:(NSString *)name value:(NSString *)value __attribute__((swift_name("doCopy(name:value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
@interface GNKKotlinCharIterator : GNKBase <GNKKotlinIterator>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)completeOp:(GNKKotlinx_coroutines_coreAtomicOp<id> *)op failure:(id _Nullable)failure __attribute__((swift_name("complete(op:failure:)")));
- (id _Nullable)failureAffected:(GNKKotlinx_coroutines_coreLockFreeLinkedListNode * _Nullable)affected __attribute__((swift_name("failure(affected:)")));
